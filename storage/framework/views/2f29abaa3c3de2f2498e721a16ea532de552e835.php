...
<html>
  <head>
    ...
    <link class="main-stylesheet" href="<?php echo e(('template/pages/css/pages.css')); ?>" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
    window.onload = function()
    {
      // fix for windows 8
      if (navigator.appVersion.indexOf("Windows NT 6.2") != -1)
        document.head.innerHTML += '<link rel="stylesheet" type="text/css" href="<?php echo e(asset('template/pages/css/windows.chrome.fix.css')); ?>" />'
    }
    </script>
  </head>
  <body class="fixed-header ">
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <img src="<?php echo e(asset('template/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg')); ?>" data-src="<?php echo e(asset('template/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg')); ?>" data-src-retina="<?php echo e(('template/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg')); ?>" alt="" class="lazy">
        <!-- END Background Pic-->
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          <!-- <img src="<?php echo e(asset('template/assets/img/logo.png')); ?>" alt="logo" data-src="<?php echo e(asset('template/assets/img/logo.png')); ?>" data-src-retina="<?php echo e(asset('template/assets/img/logo_2x.png')); ?>" width="78" height="22"> -->
          <h1>WELCOME</h1>
          <p class="p-t-35">Sign into your pages account</p>
          <!-- START Login Form -->
          <form id="form-login" class="p-t-15" role="form" method="POST" action="<?php echo e(route('login')); ?>"> 
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="pull-bottom sm-pull-bottom">
            <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
              <div class="col-sm-3 col-md-2 no-padding">
                <img alt="" class="m-t-5" data-src="<?php echo e(asset('template/assets/img/demo/pages_icon.png')); ?>" data-src-retina="<?php echo e(asset('template/assets/img/demo/pages_icon_2x.png')); ?>" height="60" src="<?php echo e(asset('template/assets/img/demo/pages_icon.png')); ?>" width="60">
              </div>
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="<?php echo e(asset('template/assets/img/logo.png')); ?>" alt="logo" data-src="<?php echo e(asset('template/assets/img/logo.png')); ?>" data-src-retina="<?php echo e(asset('template/assets/img/logo_2x.png')); ?>" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
              ...
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                    <div>
                      <img width="50" height="50" src="<?php echo e(asset('template/assets/img/profiles/avatar.jpg')); ?>" data-src="<?php echo e(asset('template/assets/img/profiles/avatar.jpg')); ?>" data-src-retina="<?php echo e(asset('assets/img/profiles/avatar2x.jpg')); ?>" alt="">
                    </div>
                  </div>
    ...
    <script type="<?php echo e(asset('template/text/javascript" src="assets/plugins/select2/js/select2.full.min.js')); ?>"></script>
    <script type="<?php echo e(asset('template/text/javascript" src="assets/plugins/classie/classie.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\file\resources\views/auth/login.blade.php ENDPATH**/ ?>
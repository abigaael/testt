    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          ...
          <li class="">
            <a href="{{ url('/mobil') }}" class="detailed">
          ...
          <li class="">
            <a href="{{ url('/customer') }}" class="detailed">
          ...
          <li class="">
            <a href="{{ route('rental.index') }}" class="detailed">
          ...
          <!-- <li>
            <a href="{{ asset('template/javascript:;') }}"><span class="title">Employees</span>
            <span class=" arrow"></span></a>
            <span class="icon-thumbnail"><i class="pg-calender"></i></span>
            <ul class="sub-menu">
              <li class="">
                <a href="{{ asset('template/calendar.html') }}">Recruitment</a>
                <span class="icon-thumbnail">R</span>
              </li>
              <li class="">
                <a href="{{ asset('template/calendar_lang.html') }}">Expenses</a>
                <span class="icon-thumbnail">E</span>
              </li>
              <li class="">
                <a href="{{ asset('template/calendar_month.html') }}">Appraisal</a>
                <span class="icon-thumbnail">A</span>
              </li>
              <li class="">
                <a href="{{ asset('template/calendar_lazy.html') }}">Pleet</a>
                <span class="icon-thumbnail">P</span>
              </li>
              <li class="">
                <a href="{{ asset('template/http://pages.revox.io/dashboard/2.1.0/doc/#calendar') }}" target="_blank">Time Off</a>

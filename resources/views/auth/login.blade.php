  ...
  <body class="fixed-header ">
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <img src="{{ asset('template/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg')}}" data-src="{{ asset('template/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg')}}" data-src-retina="{{ ('template/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg')}}" alt="" class="lazy">
        <!-- END Background Pic-->
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          <!-- <img src="{{ asset('template/assets/img/logo.png') }}" alt="logo" data-src="{{ asset('template/assets/img/logo.png') }}" data-src-retina="{{ asset('template/assets/img/logo_2x.png') }}" width="78" height="22"> -->
          <h1>WELCOME</h1>
          ...
          <div class="pull-bottom sm-pull-bottom">
            <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
              <div class="col-sm-3 col-md-2 no-padding">
                <img alt="" class="m-t-5" data-src="{{ asset('template/assets/img/demo/pages_icon.png') }}" data-src-retina="{{ asset('template/assets/img/demo/pages_icon_2x.png') }}" height="60" src="{{ asset('template/assets/img/demo/pages_icon.png')}}" width="60">
              </div>
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="{{ asset('template/assets/img/logo.png') }}" alt="logo" data-src="{{ asset('template/assets/img/logo.png') }}" data-src-retina="{{ asset('template/assets/img/logo_2x.png') }}" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
              ...
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                    <div>
                      <img width="50" height="50" src="{{ asset('template/assets/img/profiles/avatar.jpg') }}" data-src="{{ asset('template/assets/img/profiles/avatar.jpg') }}" data-src-retina="{{ asset('assets/img/profiles/avatar2x.jpg') }}" alt="">
                    </div>
                  </div>
    ...
    <script type="{{ asset('template/text/javascript" src="assets/plugins/select2/js/select2.full.min.js') }}"></script>
    <script type="{{ asset('template/text/javascript" src="assets/plugins/classie/classie.js') }}"></script>
